...
public class btle_controller : MonoBehaviour
{
	...
	private string _FullUID = "0000****-0000-1000-8000-00805f9b34fb";     // BLE-CC41a module pattern esim: "0000****-0000-1000-8000-00805f9b34fb"; 36444335-3233-3138-4E43-EC8EB55A8FD8
	private string _serviceUUID = "ffe0";
	private string _readCharacteristicUUID = "ffe1";
	private string _writeCharacteristicUUID = "ffe1";
	private string deviceToConnectTo = "BT05";

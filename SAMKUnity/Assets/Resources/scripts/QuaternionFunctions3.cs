...
public class QuaternionFunctions3 : MonoBehaviour
{
    ...
    public Quaternion normalize(float angX, float angY, float angZ, float angW)
    {
        ...
        lQuaternion = new Quaternion(angX, angY, angZ, angW);
        return lQuaternion;
    ...
    public Quaternion mult(Quaternion q, Quaternion qHelper)
    {
        ...
        Quaternion qq = new Quaternion(x, y, z, w);
        return qq;
    }
    ...
    public float getQuaternionAngle(Quaternion q1, Quaternion q2)
    {
        ...
        Debug.Log("Reciprical: " + inv);
        Quaternion res = mult(inv, q2);
        Debug.Log("Mult: " + inv + q2);
    ...
    {
        if (q1.w > 1) normalize(q1.x, q1.y, q1.z, q1.w);
